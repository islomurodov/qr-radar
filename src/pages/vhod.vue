...
<template>
  <section class="register vhod-content">
    ...
    <div class="container">
      <form @submit.prevent>
        <div class="register-content">
          ...
          <div class="vhod-subtitle">
            <p>Ваша почта / номер телефон</p>
          </div>
          ...
          <button class="btn-register" type="submit" :disabled="isLoading" @click="() => { isLoading = true; userStore.login(credentials).then(() => { isLoading = false; return router.push('/admin') }).finally(() => isLoading = false) }">
            Войти
          ...
          <!-- <div class="register-bottom">
            <div class="register-bottom-block register-bottom-block-face">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                <g clip-path="url(#clip0_103_829)">
                  <rect width="24" height="24" transform="translate(0.25 0.5)" fill="#1877F2" />
                  <path
            ...
            <div class="register-bottom-block register-bottom-block-sber">
              <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 21 21" fill="none">
                ...
                <defs>
                  <linearGradient id="paint0_linear_338_915" x1="4.00567" y1="17.5187" x2="1.36591" y2="9.98903"
                  ...
                  <linearGradient id="paint1_linear_338_915" x1="4.20198" y1="3.6046" x2="10.8638" y2="1.09957"
                    gradientUnits="userSpaceOnUse">
                    <stop offset="0.06" stop-color="#0FA7DF" />
                    <stop offset="0.54" stop-color="#0098F8" />
                    <stop offset="0.92" stop-color="#0290EA" />
                  </linearGradient>
                  <linearGradient id="paint2_linear_338_915" x1="10.0837" y1="19.4069" x2="17.6014" y2="17.7312"
                    gradientUnits="userSpaceOnUse">
                    <stop offset="0.12" stop-color="#A2CC39" />
                    <stop offset="0.28" stop-color="#86C239" />
                    <stop offset="0.87" stop-color="#219F38" />
                  </linearGradient>
                  <linearGradient id="paint3_linear_338_915" x1="10.2568" y1="0.950497" x2="16.6906" y2="2.90957"
                    gradientUnits="userSpaceOnUse">
                    <stop offset="0.06" stop-color="#0290EA" />
                    <stop offset="0.79" stop-color="#0C89CA" />
                  </linearGradient>
                  <linearGradient id="paint4_linear_338_915" x1="3.76959" y1="17.1529" x2="10.7791" y2="19.7379"
                    gradientUnits="userSpaceOnUse">
                  ...
                  <linearGradient id="paint5_linear_338_915" x1="1.41608" y1="10.7889" x2="4.28658" y2="3.42086"
                    gradientUnits="userSpaceOnUse">
          ...
          <div class="register-bottom-block register-bottom-block-google" style="width: 100%; margin-top: 10px">
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
